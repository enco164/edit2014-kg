package com.android.devicehive.commands;
...
public class GetApiInfoCommand extends JsonNetworkCommand {
	...
	public static Parcelable.Creator<GetApiInfoCommand> CREATOR = new Parcelable.Creator<GetApiInfoCommand>() {
	...
	/**
	 * Get {@link ApiInfo} object from response {@link Bundle} container.
	 * 
	 * @param resultData
