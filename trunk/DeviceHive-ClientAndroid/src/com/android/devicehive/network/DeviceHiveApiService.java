...
/**
 * Android {@link Service} subclass which is used to concurrently execute
 * commands sent via {@link Intent}. This service should be declared in
 * AndroidManifest.xml file. Can execute commands either concurrently or in FIFO
 * order.
 * 
 * @see {@link NetworkCommand#isSerial()}
 */
