...
public abstract class ServiceConnection {
	...
	protected void startNetworkCommand(NetworkCommand command) {
		//Log.d("ServiceConnection.startNetworkCommand()", getCommandConfig().toString());
	...
	public String toString() {
		return "ServiceConnection [context=" + context + ", apiEndpointUrl="
				+ apiEndpointUrl + ", getCommandConfig()=" + getCommandConfig()
				+ "]";
	}
